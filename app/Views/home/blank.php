...
<head>
  ...
  <title>AdminLTE 3 with CodeIgniter 4| Blank Page </title>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?= base_url() ?>/assets/static/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <!-->  <img src="<?= base_url() ?>/assets/static/dist/img/avatar3.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?= date('Y') ?> <a href="#">Company.com</a>.</strong>
    All rights reserved.
...
<!-- overlayScrollbars -->
<script src="<?= base_url() ?>/assets/static/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
...
<script src="<?= base_url() ?>/ssets/static/dist/js/pages/dashboard2.js"></script>
</body>
</html>